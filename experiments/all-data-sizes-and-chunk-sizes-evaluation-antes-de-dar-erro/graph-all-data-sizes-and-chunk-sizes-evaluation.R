...
setwd("/dados/rogerio/USP/doutorado/prova-de-conceito/testes-prova-conceito/openmp-hook/experiments/all-data-sizes-and-chunk-sizes-evaluation/graph");

# Load data about OMP, CUDA, OMP_OFF.
data = read.csv("/dados/rogerio/USP/doutorado/prova-de-conceito/testes-prova-conceito/openmp-hook/experiments/all-data-sizes-and-chunk-sizes-evaluation/graph/gemm-ragserver-cuda-all-data-sizes-and-chunk-sizes-evaluation-11-11-2016-18-51-34-and-omp-all-data-sizes-and-chunk-sizes-evaluation-09-11-2016-12-16-41-joined-processed-final.csv");
View(data)
