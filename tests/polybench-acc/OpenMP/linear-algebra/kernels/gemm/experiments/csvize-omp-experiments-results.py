...
#Execution = 9, benchmark = gemm, size_of_data = LARGE_DATASET, schedule = DYNAMIC, chunk_size = 64, num_threads = 24
#exp = OMP, num_threads = 24, NI = 2048, NJ = 2048 , NK = 2048, ORIG = 102.297021
#, OMP = 18.449981
#
