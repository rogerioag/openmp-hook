...
data = read.csv("/dados/rogerio/USP/doutorado/prova-de-conceito/testes-prova-conceito/openmp-hook/experiments/chunk_size_evaluation/graph/syr2k-28-06-2016-20-40-38-joined-processed-final.csv");
View(data)
...
write.csv(test, file = "syr2k-execucoes-nao-alcancaram-ponto-decisao.csv")
...
pdf(filename="evaluating-chunk_size-benchmark-syr2k-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-16.pdf", width=1200, height=800);
...
p1 <- ggplot(df_plot_16, aes(x=x, y=t, fill=cat)) + 
  ...
  ggtitle("Offloading Analysis for syr2k (Number of Threads with chunk_size = 16)\n") +
...
multiplot(p1, cols=1)
dev.copy2pdf(file = "evaluating-chunk_size-benchmark-syr2k-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-16.pdf");
# dev.off ();
...
pdf(filename="evaluating-chunk_size-benchmark-syr2k-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-32.pdf", width=1200, height=800);
...
p2 <- ggplot(df_plot_32, aes(x=x, y=t, fill=cat)) + 
  ...
  #           breaks=c("OMP+OFF", "OMP"),
  #           labels=c("OMP+OFF", "OMP"), values=c("#494949", "#927080", "#B6B6B6")) +
  ggtitle("Offloading Analysis for syr2k (Number of Threads with chunk_size = 32)\n") +
  # scale_y_continuous(trans='log') +
  scale_y_continuous() +
  # scale_y_log10() +
  theme_bw() +
...
multiplot(p2, cols=1)
dev.copy2pdf(file = "evaluating-chunk_size-benchmark-syr2k-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-32.pdf");
# dev.off ();
...
p3 <- ggplot(df_plot_64, aes(x=x, y=t, fill=cat)) + 
  ...
  #           breaks=c("OMP+OFF", "OMP"),
  #           labels=c("OMP+OFF", "OMP"), values=c("#494949", "#927080", "#B6B6B6")) +
  ggtitle("Offloading Analysis for syr2k (Number of Threads with chunk_size = 64)\n") +
  # scale_y_continuous(trans='log') +
  scale_y_continuous() +
  # scale_y_log10() +
  theme_bw() +
...
multiplot(p3, cols=1)
dev.copy2pdf(file = "evaluating-chunk_size-benchmark-syr2k-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-64.pdf");
# dev.off ();
...
pdf(filename="evaluating-chunk_size-benchmark-syr2k-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-128.pdf", width=1200, height=800);
...
p4 <- ggplot(df_plot_128, aes(x=x, y=t, fill=cat)) + 
  ...
  #           breaks=c("OMP+OFF", "OMP"),
  #           labels=c("OMP+OFF", "OMP"), values=c("#494949", "#927080", "#B6B6B6")) +
  ggtitle("Offloading Analysis for syr2k (Number of Threads with chunk_size = 128)\n") +
  # scale_y_continuous(trans='log') +
  scale_y_continuous() +
  # scale_y_log10() +
  theme_bw() +
...
multiplot(p4, cols=1)
dev.copy2pdf(file = "evaluating-chunk_size-benchmark-syr2k-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-128.pdf");
# dev.off ();
...
pdf(filename="evaluating-chunk_size-benchmark-syr2k-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-256.pdf", width=1200, height=800);
...
p5 <- ggplot(df_plot_256, aes(x=x, y=t, fill=cat)) + 
  ...
  #           breaks=c("OMP+OFF", "OMP"),
  #           labels=c("OMP+OFF", "OMP"), values=c("#494949", "#927080", "#B6B6B6")) +
  ggtitle("Offloading Analysis for syr2k (Number of Threads with chunk_size = 256)\n") +
  # scale_y_continuous(trans='log') +
  scale_y_continuous() +
  # scale_y_log10() +
  theme_bw() +
...
multiplot(p5, cols=1)
dev.copy2pdf(file = "evaluating-chunk_size-benchmark-syr2k-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-256.pdf");
# dev.off ();
