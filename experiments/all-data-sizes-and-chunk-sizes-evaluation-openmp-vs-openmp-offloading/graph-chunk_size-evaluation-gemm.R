...
setwd("/dados/rogerio/USP/doutorado/prova-de-conceito/testes-prova-conceito/openmp-hook/experiments/all-data-sizes-and-chunk-sizes-evaluation-openmp-vs-openmp-offloading/graph/");

# Load data about OMP, CUDA, OMP_OFF.
data = read.csv("/dados/rogerio/USP/doutorado/prova-de-conceito/testes-prova-conceito/openmp-hook/experiments/all-data-sizes-and-chunk-sizes-evaluation-openmp-vs-openmp-offloading/csv/pilipili2/gemm-pilipili2-omp-all-data-sizes-and-chunk-sizes-evaluation-11-08-2016-18-44-48-and-gemm-pilipili2-openmp-offloading-all-data-sizes-and-chunk-sizes-evaluation-17-11-2016-13-15-25-joined-processed-final.csv");
View(data)
...
cdata <- ddply(data, c("exp", "version", "schedule", "chunk_size" , "num_threads" , "size_of_data" , "NI" , "NJ" , "NK"), summarise,
                   ...
                   # mean_cuda = mean(CUDA_KERNEL1 + CUDA_KERNEL2 + CUDA_KERNEL3),
                   ...
                   # sd_cuda = 2 * sd(CUDA_KERNEL1 + CUDA_KERNEL2 + CUDA_KERNEL3),
...
df_plot_16 <- subset(df_data, y== 256 & z == 4096)

View(df_plot_16)

write.csv(df_plot_16, file = "omp-ompoff-df-plot-chunksize-16.csv")
