...
info:
	@echo "make OPTIONS=\"-D[HASWELL | IVY_BRIDGE | SANDY_BRIDGE | NEHALEM]\""
	@echo "For compiling with DEBUG messages, use:"
	@echo "make OPTIONS=\"-DVERBOSE -DDEBUG -D[HASWELL | IVY_BRIDGE | SANDY_BRIDGE | NEHALEM]\""
	@echo "For compiling with FORCENOOFFLOAD, use:"
	@echo "make OPTIONS=\"-DFORCENOOFFLOAD -D[HASWELL | IVY_BRIDGE | SANDY_BRIDGE | NEHALEM]\""
	@echo "For compiling with DEBUG messages and force no offloading, use:"
	@echo "make OPTIONS=\"-DVERBOSE -DDEBUG -DFORCENOOFFLOAD -D[HASWELL | IVY_BRIDGE | SANDY_BRIDGE | NEHALEM] \""
