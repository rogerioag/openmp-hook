...
data = read.csv("/dados/rogerio/USP/doutorado/prova-de-conceito/testes-prova-conceito/openmp-hook/experiments/chunk_size_evaluation/graph/gemm-28-06-2016-00-03-28-joined-processed-final.csv");
View(data)
...
pdf(filename="evaluating-chunk_size-benchmark-gemm-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-16.pdf", width=1200, height=800);
...
multiplot(p1, cols=1)
dev.copy2pdf(file = "evaluating-chunk_size-benchmark-gemm-data-large_dataset-num_threads-1-a-24-dynamic-chunk_size-16.pdf");
# dev.off ();
