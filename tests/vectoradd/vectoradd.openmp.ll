...
polly.split_new_and_old:                          ; preds = %overflow.checked
  br i1 or (i1 icmp ule ([1024 x float]* bitcast (<4 x float>* getelementptr (<4 x float>* bitcast ([1024 x float]* @h_b to <4 x float>*), i64 256) to [1024 x float]*), [1024 x float]* @h_a), i1 icmp ule ([1024 x float]* bitcast (<4 x float>* getelementptr (<4 x float>* bitcast ([1024 x float]* @h_a to <4 x float>*), i64 256) to [1024 x float]*), [1024 x float]* @h_b)), label %polly.start, label %vector.body

vector.body:                                      ; preds = %polly.split_new_and_old, %vector.body
  %index = phi i64 [ 0, %polly.split_new_and_old ], [ %index.next.1, %vector.body ]
  ...
  br i1 %18, label %polly.merge_new_and_old, label %vector.body, !llvm.loop !7

polly.merge_new_and_old:                          ; preds = %polly.start, %vector.body
  ret void

polly.start:                                      ; preds = %polly.split_new_and_old
  %19 = bitcast {}* %polly.par.userContext to i8*
  call void @llvm.lifetime.start(i64 0, i8* %19)
  %polly.par.userContext1 = bitcast {}* %polly.par.userContext to i8*
  call void @GOMP_parallel_loop_runtime_start(void (i8*)* @init_array.polly.subfn, i8* %polly.par.userContext1, i32 0, i64 0, i64 64, i64 1)
...
polly.split_new_and_old:                          ; preds = %overflow.checked
  br i1 and (i1 and (i1 or (i1 icmp ule ([1024 x float]* bitcast (<4 x float>* getelementptr (<4 x float>* bitcast ([1024 x float]* @h_a to <4 x float>*), i64 256) to [1024 x float]*), [1024 x float]* @h_c), i1 icmp ule ([1024 x float]* bitcast (<4 x float>* getelementptr (<4 x float>* bitcast ([1024 x float]* @h_c to <4 x float>*), i64 256) to [1024 x float]*), [1024 x float]* @h_a)), i1 or (i1 icmp ule ([1024 x float]* bitcast (<4 x float>* getelementptr (<4 x float>* bitcast ([1024 x float]* @h_b to <4 x float>*), i64 256) to [1024 x float]*), [1024 x float]* @h_c), i1 icmp ule ([1024 x float]* bitcast (<4 x float>* getelementptr (<4 x float>* bitcast ([1024 x float]* @h_c to <4 x float>*), i64 256) to [1024 x float]*), [1024 x float]* @h_b))), i1 or (i1 icmp ule ([1024 x float]* bitcast (<4 x float>* getelementptr (<4 x float>* bitcast ([1024 x float]* @h_b to <4 x float>*), i64 256) to [1024 x float]*), [1024 x float]* @h_a), i1 icmp ule ([1024 x float]* bitcast (<4 x float>* getelementptr (<4 x float>* bitcast ([1024 x float]* @h_a to <4 x float>*), i64 256) to [1024 x float]*), [1024 x float]* @h_b))), label %polly.start, label %vector.body
...
vector.body12:                                    ; preds = %vector.body12, %vector.body12.preheader
  ...
  br i1 %33, label %polly.merge_new_and_old, label %vector.body12, !llvm.loop !11

polly.merge_new_and_old:                          ; preds = %polly.start, %vector.body12
...
; <label>:36                                      ; preds = %36, %polly.merge_new_and_old
  %indvars.iv.i1 = phi i64 [ 0, %polly.merge_new_and_old ], [ %indvars.iv.next.i2, %36 ]
...
polly.start:                                      ; preds = %polly.split_new_and_old
  %60 = bitcast {}* %polly.par.userContext to i8*
  call void @llvm.lifetime.start(i64 0, i8* %60)
  %polly.par.userContext1 = bitcast {}* %polly.par.userContext to i8*
  call void @GOMP_parallel_loop_runtime_start(void (i8*)* @main.polly.subfn, i8* %polly.par.userContext1, i32 0, i64 0, i64 64, i64 1)
  call void @main.polly.subfn(i8* %polly.par.userContext1)
  call void @GOMP_parallel_end()
  %61 = bitcast {}* %polly.par.userContext to i8*
  call void @llvm.lifetime.end(i64 8, i8* %61)
  %62 = bitcast {}* %polly.par.userContext2 to i8*
  call void @llvm.lifetime.start(i64 0, i8* %62)
  %polly.par.userContext3 = bitcast {}* %polly.par.userContext2 to i8*
  call void @GOMP_parallel_loop_runtime_start(void (i8*)* @main.polly.subfn1, i8* %polly.par.userContext3, i32 0, i64 0, i64 128, i64 1)
  call void @main.polly.subfn1(i8* %polly.par.userContext3)
  call void @GOMP_parallel_end()
  %63 = bitcast {}* %polly.par.userContext2 to i8*
...
polly.loop_header:                                ; preds = %polly.stmt.vector.body, %polly.loop_preheader
  %polly.indvar = phi i64 [ %polly.par.LB, %polly.loop_preheader ], [ %polly.indvar_next, %polly.stmt.vector.body ]
  br label %polly.stmt.vector.body

polly.stmt.vector.body:                           ; preds = %polly.loop_header
  %2 = mul i64 %polly.indvar, 16
  %scevgep = getelementptr [1024 x float]* @h_a, i64 0, i64 %2
  %scevgep2 = bitcast float* %scevgep to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep2, align 16, !alias.scope !12, !noalias !14
  %scevgep3 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_a, i64 0, i64 4), i64 %2
  %scevgep34 = bitcast float* %scevgep3 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep34, align 16, !alias.scope !12, !noalias !14
  %3 = mul i64 %polly.indvar, 16
  %scevgep5 = getelementptr [1024 x float]* @h_b, i64 0, i64 %3
  %scevgep56 = bitcast float* %scevgep5 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep56, align 16, !alias.scope !15, !noalias !16
  %scevgep7 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_b, i64 0, i64 4), i64 %3
  %scevgep78 = bitcast float* %scevgep7 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep78, align 16, !alias.scope !15, !noalias !16
  %4 = mul i64 %polly.indvar, 16
  %scevgep9 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_a, i64 0, i64 8), i64 %4
  %scevgep910 = bitcast float* %scevgep9 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep910, align 16, !alias.scope !12, !noalias !14
  %scevgep11 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_a, i64 0, i64 12), i64 %4
  %scevgep1112 = bitcast float* %scevgep11 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep1112, align 16, !alias.scope !12, !noalias !14
  %5 = mul i64 %polly.indvar, 16
  %scevgep13 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_b, i64 0, i64 8), i64 %5
  %scevgep1314 = bitcast float* %scevgep13 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep1314, align 16, !alias.scope !15, !noalias !16
  %scevgep15 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_b, i64 0, i64 12), i64 %5
  %scevgep1516 = bitcast float* %scevgep15 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep1516, align 16, !alias.scope !15, !noalias !16
  %6 = mul i64 %polly.indvar, 16
  %7 = add i64 %6, 16
  %p_ = icmp eq i64 %7, 1024
...
polly.stmt.vector.body:                           ; preds = %polly.loop_header
  ...
  %scevgep = getelementptr [1024 x float]* @h_a, i64 0, i64 %2
  %scevgep2 = bitcast float* %scevgep to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep2, align 16, !alias.scope !17, !noalias !19
  %scevgep3 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_a, i64 0, i64 4), i64 %2
  %scevgep34 = bitcast float* %scevgep3 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep34, align 16, !alias.scope !17, !noalias !19
  %3 = mul i64 %polly.indvar, 16
  %scevgep5 = getelementptr [1024 x float]* @h_b, i64 0, i64 %3
  %scevgep56 = bitcast float* %scevgep5 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep56, align 16, !alias.scope !20, !noalias !22
  %scevgep7 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_b, i64 0, i64 4), i64 %3
  %scevgep78 = bitcast float* %scevgep7 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep78, align 16, !alias.scope !20, !noalias !22
  %4 = mul i64 %polly.indvar, 16
  %scevgep9 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_a, i64 0, i64 8), i64 %4
  %scevgep910 = bitcast float* %scevgep9 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep910, align 16, !alias.scope !17, !noalias !19
  %scevgep11 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_a, i64 0, i64 12), i64 %4
  %scevgep1112 = bitcast float* %scevgep11 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep1112, align 16, !alias.scope !17, !noalias !19
  %5 = mul i64 %polly.indvar, 16
  %scevgep13 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_b, i64 0, i64 8), i64 %5
  %scevgep1314 = bitcast float* %scevgep13 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep1314, align 16, !alias.scope !20, !noalias !22
  %scevgep15 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_b, i64 0, i64 12), i64 %5
  %scevgep1516 = bitcast float* %scevgep15 to <4 x float>*
  store <4 x float> <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>, <4 x float>* %scevgep1516, align 16, !alias.scope !20, !noalias !22
  %6 = mul i64 %polly.indvar, 16
  %7 = add i64 %6, 16
  %p_ = icmp eq i64 %7, 1024
  %polly.indvar_next = add nsw i64 %polly.indvar, 1
...
define internal void @main.polly.subfn1(i8* %polly.par.userContext) #3 {
polly.par.setup:
  %polly.par.LBPtr = alloca i64
  %polly.par.UBPtr = alloca i64
  %polly.par.userContext1 = bitcast i8* %polly.par.userContext to {}*
...
polly.loop_exit:                                  ; preds = %polly.stmt.vector.body12
  br label %polly.par.checkNext

polly.loop_header:                                ; preds = %polly.stmt.vector.body12, %polly.loop_preheader
  %polly.indvar = phi i64 [ %polly.par.LB, %polly.loop_preheader ], [ %polly.indvar_next, %polly.stmt.vector.body12 ]
  br label %polly.stmt.vector.body12

polly.stmt.vector.body12:                         ; preds = %polly.loop_header
  %2 = mul i64 %polly.indvar, 8
  %scevgep = getelementptr [1024 x float]* @h_a, i64 0, i64 %2
  %scevgep2 = bitcast float* %scevgep to <4 x float>*
  %wide.load_p_scalar_ = load <4 x float>* %scevgep2, align 16, !alias.scope !17, !noalias !19
  %scevgep3 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_a, i64 0, i64 4), i64 %2
  %scevgep34 = bitcast float* %scevgep3 to <4 x float>*
  %wide.load27_p_scalar_ = load <4 x float>* %scevgep34, align 16, !alias.scope !17, !noalias !19
  %3 = mul i64 %polly.indvar, 8
  %scevgep5 = getelementptr [1024 x float]* @h_b, i64 0, i64 %3
  %scevgep56 = bitcast float* %scevgep5 to <4 x float>*
  %wide.load28_p_scalar_ = load <4 x float>* %scevgep56, align 16, !alias.scope !20, !noalias !22
  %scevgep7 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_b, i64 0, i64 4), i64 %3
  %scevgep78 = bitcast float* %scevgep7 to <4 x float>*
  %wide.load29_p_scalar_ = load <4 x float>* %scevgep78, align 16, !alias.scope !20, !noalias !22
  %p_ = fadd <4 x float> %wide.load_p_scalar_, %wide.load28_p_scalar_
  %p_9 = fadd <4 x float> %wide.load27_p_scalar_, %wide.load29_p_scalar_
  %4 = mul i64 %polly.indvar, 8
  %scevgep10 = getelementptr [1024 x float]* @h_c, i64 0, i64 %4
  %scevgep1011 = bitcast float* %scevgep10 to <4 x float>*
  store <4 x float> %p_, <4 x float>* %scevgep1011, align 16, !alias.scope !21, !noalias !23
  %scevgep12 = getelementptr float* getelementptr inbounds ([1024 x float]* @h_c, i64 0, i64 4), i64 %4
  %scevgep1213 = bitcast float* %scevgep12 to <4 x float>*
  store <4 x float> %p_9, <4 x float>* %scevgep1213, align 16, !alias.scope !21, !noalias !23
  %5 = mul i64 %polly.indvar, 8
  %6 = add i64 %5, 8
  %p_14 = icmp eq i64 %6, 1024
  %polly.indvar_next = add nsw i64 %polly.indvar, 1
  %polly.adjust_ub = sub i64 %polly.par.UBAdjusted, 1
  %polly.loop_cond = icmp sle i64 %polly.indvar, %polly.adjust_ub
  br i1 %polly.loop_cond, label %polly.loop_header, label %polly.loop_exit
...
!10 = distinct !{!10, !8, !9}
!11 = distinct !{!11, !8, !9}
!12 = distinct !{!12, !13, !"polly.alias.scope.h_a"}
!13 = distinct !{!13, !"polly.alias.scope.domain"}
!14 = !{!15}
!15 = distinct !{!15, !13, !"polly.alias.scope.h_b"}
!16 = !{!12}
!17 = distinct !{!17, !18, !"polly.alias.scope.h_a"}
!18 = distinct !{!18, !"polly.alias.scope.domain"}
!19 = !{!20, !21}
!20 = distinct !{!20, !18, !"polly.alias.scope.h_b"}
!21 = distinct !{!21, !18, !"polly.alias.scope.h_c"}
!22 = !{!17, !21}
!23 = !{!20, !17}
